...
- **Beste jokalarien mugimenduak**
  - zerbitzariak broadcast egiten du, eta aplikazioak “log/feed” moduan erakutsi dezake (nork zer egin duen).

### 7) Errondak + puntuazioa
- **RONDA mezuak**
  - fasea aldatu (HANDIAK/TXIKIAK/PAREAK/JOKUA/PUNTUA…), UI egokitu.
- **LABURPENA / PUNTUAKJASO**
  - errondaren emaitza eta puntu eguneraketak jaso eta markagailua eguneratu.

### 8) Error/exit kudeaketa (deskonexioak)
- **END_GAME**
  - partida amaitu edo apurtu denean, konexioa itxi eta erabiltzailea menura/amaierara bidali.
- **Timeout / socket itxiera**
  - irakurketa loop-ean errorea harrapatu eta UI-n mezu argi bat eman.

> Oharra: atal hau “eredu” modukoa da. Zure repoan izenak/deskribapenak berdinak ez badira ere, funtzioa antzekoa izaten da: **network layer + state/game flow + UI screens**.
